...
Client side routing is the same as server side routing but the browser is responsible for routing between pages. This is typically used in single page applications.
...
This refers to an input form element whose value is controlled by React. React state is the "single source of truth" for the component
